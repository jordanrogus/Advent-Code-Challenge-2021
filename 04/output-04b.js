...
// Function for part 2
const partTwo = (bingoInput, bingoBoardMultiDimArray) => {
    ...
    for (i = 0; i < bingoInput.length; i++) {
        ...
        for (j = 0; j < updatedBingoBoards.length; j++) {
            ...
            if (win == true) {
                ...
                // Remove board from bingo board unless it is the last one
                if (updatedBingoBoards.length != 1){

                    updatedBingoBoards.splice(j, 1);
...
console.log('Part Two: ' + partTwo(bingoInput, bingoBoardMultiDimArray));
