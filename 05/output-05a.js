...
// Function to retrieve horizontal and vertical points between two passed in endpoints (as x1,y1 and x2,y2)
function _retrieveCoordinates(x1, y1, x2, y2) {
    ...
    // If horizontal or vertical then calculate the coordinates on the line segments and push to the finalArray
    if(x1==x2 || y1==y2){
